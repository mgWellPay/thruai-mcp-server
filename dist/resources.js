...
export function registerResources(server, client) {
    ...
    server.resource('agents', 'thruai://agents', { description: 'List of all voice agents' }, async () => {
    ...
    server.resource('workflows', 'thruai://workflows', { description: 'List of all workflows' }, async () => {
    ...
    server.resource('providers', 'thruai://providers', { description: 'Available LLM, TTS, and STT providers with their models and voices' }, async () => {
    ...
    // Lists all campaigns
    server.resource('campaigns', 'thruai://campaigns', { description: 'List of all outbound calling campaigns' }, async () => {
    ...
    server.resource('webhooks', 'thruai://webhooks', { description: 'List of all webhook subscriptions' }, async () => {
    ...
    server.resource('custom-tools', 'thruai://tools', { description: 'List of all custom webhook-based tools' }, async () => {
    ...
    // Lists recent calls
    server.resource('recent-calls', 'thruai://calls/recent', { description: 'Recent call history' }, async () => {
